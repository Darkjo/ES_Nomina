...
Partial Public Class ESNomina
    ...
    Partial Public Class EmpleadosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddEmpleadosRow(ByVal Username As String, ByVal PassEmpleado As String, ByVal NombreEmpleado As String, ByVal TelefonoEmpleado As Integer, ByVal Sueldo As Integer, ByVal Estado As Boolean, ByVal Marcado As Boolean, ByVal Catalogo As Boolean, ByVal Consulta As Boolean, ByVal Reporte As Boolean, ByVal Administrador As Boolean) As EmpleadosRow
            Dim rowEmpleadosRow As EmpleadosRow = CType(Me.NewRow,EmpleadosRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Username, PassEmpleado, NombreEmpleado, TelefonoEmpleado, Sueldo, Estado, Marcado, Catalogo, Consulta, Reporte, Administrador}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function FindByUsername(ByVal Username As String) As EmpleadosRow
            Return CType(Me.Rows.Find(New Object() {Username}),EmpleadosRow)
        End Function
...
Namespace ESNominaTableAdapters
    ...
    Partial Public Class EmpleadosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [ESNomina].[dbo].[Empleados] ([Username], [PassEmpleado], [NombreEmpl"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(3).CommandText = "SELECT * FROM Empleados WHERE  (Username = @Username)"
            ...
            Me._commandCollection(4).CommandText = "SELECT Username, PassEmpleado, NombreEmpleado, TelefonoEmpleado, Sueldo, Estado, "& _ 
        ...
        Public Overloads Overridable Function GetDataBy1(ByVal Username As String) As ESNomina.EmpleadosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            If (Username Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy11(ByVal Username As String, ByVal PassEmpleado As String) As ESNomina.EmpleadosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(4)
            If (Username Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
